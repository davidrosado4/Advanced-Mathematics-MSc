...
#include<math.h>
#include<complex.h>
void newton1(double complex z0,double tol, FILE *fitxer0,FILE *fitxer1,FILE *fitxer2,FILE *fitxer3);
...
int main(void){
     int i;
     FILE *fitxer0,*fitxer1,*fitxer2,*fitxer3,*condin,*comprovacio;
    ...
    while(m>-10){
        ...
        while(h<10){
            h=h+0.1;
            z0=h+m*I;
            newton1(z0,tol,fitxer0,fitxer1,fitxer2,fitxer3);
        }
    }
...
double complex derp(double complex z){
    return z*(z-0.9) + (z-1)*(z-0.9) + (z-1)*z;
}
double modul(double complex z){
    double valor;
